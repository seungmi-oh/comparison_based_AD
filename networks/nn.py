...
class NN(nn.Module):
    ...
    """
    def __init__(self, in_channels, num_channels, num_blocks, out_channels, drop_prob, use_attn=True, aux_channels=None):
        ...
        self.out_conv = WNConv2d(num_channels, out_channels,
...
class GatedAttn(nn.Module):
    ...
    Args:
        ...
        drop_prob (float): Dropout probability.
    """
    def __init__(self, d_model, num_heads=1, drop_prob=0.):
